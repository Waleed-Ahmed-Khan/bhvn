...
def preprocess_tprs(complete_df, start_date, end_date, year, po_selection, customer_selection, station_selection, mastercode_selection, size_selection):
...
def preprocess_tprs_lastworking(complete_df):
    total_output = complete_df['qty'].sum()
    total_target = complete_df['target'].sum()
    total_co = complete_df['C/O'].sum()
