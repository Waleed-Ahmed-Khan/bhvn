...
from orderStatusPckg.status_main import render_overall_status
from orderStatusPckg.status_sewing import render_sewing_status
from orderStatusPckg.status_auto import render_auto_status
from orderStatusPckg.status_packing import render_packing_status
from orderStatusPckg.status_cutting import render_cutting_status
from orderStatusPckg.status_printing import render_printing_status
from orderStatusPckg.status_issuance import render_issuance_status
from orderStatusPckg.status_final_inspection import render_final_inspection_status
from orderStatusPckg.status_purchase import render_purchase_status
...
def render_order_status(username):
    ...
    try:
        if selection == 'Overall Status' :
            try:
                render_overall_status(username)
